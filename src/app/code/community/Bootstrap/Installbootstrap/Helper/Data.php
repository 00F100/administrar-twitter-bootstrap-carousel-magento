<?php
class Bootstrap_Installbootstrap_Helper_Data extends Mage_Core_Helper_Abstract
{
   ...
   public function getStaticBlockData() {
        $xmlPath = Mage::getBaseDir('code') . '/local/Bootstrap/Installbootstrap/Block/Xml/data_static_blocks.xml';
    ...
    public function getCmsPageData() {
        ...
        $xmlPath = Mage::getBaseDir('code') . '/local/Bootstrap/Installbootstrap/Block/Xml/data_resources.xml';
    ...
    public function getOldConfigData(){
     ...
     public function getCarouselData() {
        ...
        $xmlPath = Mage::getBaseDir('code') . '/local/Bootstrap/Installbootstrap/Block/Xml/carousel.xml';
